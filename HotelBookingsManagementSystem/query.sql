...
insert into Users values(Users_seq.nextVal,'mahi123','customer','mahihari','9885467005','9177453136','tirupati','mahi@gmail.com');
insert into Users values(Users_seq.nextVal,'jothi12','admin','mahihari','9985467006','9177453454','chennai','jothi@gmail.com');
insert into Users values(Users_seq.nextVal,'sound12','employee','mahihari','9676662841','9701048244','chennai','sound@gmail.com');
...
insert into Hotel values(Hotel_seq.nextVal,'chennai','bliss','chengalpattu','fivestar',1500,'8866553322','9876543210',4,'bliss@gmail','0896325');
...
insert into Hotel values(Hotel_seq.nextVal,'banglore','manasa','thambaram','threestar',1000,'9966253389','8123541234',3,'manasa@gmail','0812323');

delete from Hotel where hotel_id=101;
...
availability char(3) check (availability in ('yes','no')));
...
insert into ROOMDETAILS values (100,RoomDetails_seq.nextval,'110','Standard non A/C room',2500,'yes');
...
delete from BOOKINGDETAILS where room_id = 6004;
